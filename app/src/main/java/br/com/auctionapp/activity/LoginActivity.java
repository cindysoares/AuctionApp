...
public class LoginActivity extends AuctionsAppActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextIntent = (Intent) getIntent().getParcelableExtra("nextIntent");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, User> {
        ...
        protected User doInBackground(Void... params) {
            ...
            return DAOFactory.getUserDAO().find(mEmail);
        }
        ...
        protected void onPostExecute(final User registedUser) {
            ...
            if (registedUser == null) {
                ...
                getApplicationContext().setLoggedUser(registedUser);
                finish();
            } else {
    ...
    public class RegisterUserTask extends AsyncTask<Void, Void, User> {
        ...
        protected User doInBackground(Void... params) {
            ...
            User registeredUser = new User(mEmail, mPassword);
            return DAOFactory.getUserDAO().save(registeredUser);
        }
        ...
        protected void onPostExecute(final User registeredUser) {
            ...
            if (registeredUser != null) {
                getApplicationContext().setLoggedUser(registeredUser);
                finish();
            } else {
